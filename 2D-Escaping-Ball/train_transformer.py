...
def main():
    ...
    parser.add_argument("--log_path", type=str, default="loss_transformer.csv")
    parser.add_argument("--device", type=str, default="cuda")
    parser.add_argument("--model_path", type=str, default="pretrained/transformer_test.pth")
    ...
    input_columns = [f"scan_{i}" for i in range(360)]
